...
class Connection:
    ...
    def adapter_receiving(self):
        ...
        # python3 RUSHBAdapter.py 59767 > ADAPTER_RECEIVING.aout
    ...
    def switch_global_greeting(self, modified_test_name="SWITCH_GLOBAL_GREETING"):
        ...
        # python3 RUSHBSwitch.py global 130.0.0.1/8 2 2 < SWITCH_GLOBAL_GREETING.b2in > SWITCH_GLOBAL_GREETING.b2out
    ...
    def minimap_3(self):
        ...
        # python3 RUSHBSwitch.py global 130.0.0.1/8 2 2 < MINIMAP_3.b2in > MINIMAP_3.b2out
    ...
    def switch_local2_greeting(self, modified_test_name="SWITCH_LOCAL2_GREETING"):
        ...
        # python3 RUSHBSwitch.py local 10.0.0.1/8 130.0.0.1/8 2 2 > SWITCH_LOCAL2_GREETING.b2out
    ...
    def switch_forward_message(self):
        ...
        # python3 RUSHBSwitch.py local 192.168.1.1/24 0 2 < SWITCH_FORWARD_MESSAGE.b2in > SWITCH_FORWARD_MESSAGE.b2out
    ...
    def switch_distance_switch(self, modified_test_name="SWITCH_DISTANCE_SWITCH"):
        ...
        # python3 RUSHBSwitch.py local 192.168.1.1/24 0 2 < SWITCH_DISTANCE_SWITCH.b2in > SWITCH_DISTANCE_SWITCH.b2out
    ...
    def switch_routing_simple(self, test_name="SWITCH_ROUTING_SIMPLE", data_destination="134.0.0.1", d1=3, d2=5):
        ...
        # python3 RUSHBSwitch.py local 192.168.1.1/24 0 2 < SWITCH_ROUTING_SIMPLE.b2in > SWITCH_ROUTING_SIMPLE.b2out
    ...
    def switch_routing_prefix(self):
        ...
        # python3 RUSHBSwitch.py local 192.168.1.1/24 0 2 < SWITCH_ROUTING_PREFIX.b2in > SWITCH_ROUTING_PREFIX.b2out
